...
[![Tests](https://img.shields.io/badge/tests-234%2F234-brightgreen)](https://github.com/flaviomoreir4/laravel-transfeera/actions/workflows/ci.yml)
...
```bash
composer test              # Pest (234 testes, 342 asserções)
