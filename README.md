...
[![Tests](https://img.shields.io/badge/tests-259%2F259-brightgreen)](https://github.com/flaviomoreir4/laravel-transfeera/actions/workflows/ci.yml)
...
```bash
composer test              # Pest (259 testes, 396 asserções)
