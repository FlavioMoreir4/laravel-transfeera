...
class PaymentsWebhookResource extends BaseResource
{
    ...
    {
        return $this->deleteDTO(Connector::DOMAIN_PAYMENTS, self::BASE_PATH_URLS.'/'.$id, OperationResponseDTO::class);
    }
    ...
    {
        return $this->postDTO(Connector::DOMAIN_PAYMENTS, self::BASE_PATH_EVENTS.'/'.$eventId.'/retry', [], OperationResponseDTO::class);
    }
}
