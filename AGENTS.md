...
```bash
composer test          # Pest 5 (169 testes, 242 asserções)
...
- **Pest 5** — 169 testes, 242 asserções (v1.8.0)
...
Todo o conteúdo de `docs/` está criado e sincronizado com a v1.8.0 (14 arquivos):
