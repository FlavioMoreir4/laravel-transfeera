...
```bash
composer test          # Pest 4 (118 testes, 160 asserções)
...
- **Pest 4** — 118 testes, 160 asserções (última verificação: v1.7.0)
...
Todo o conteúdo de `docs/` está criado e sincronizado com a v1.7.0 (13 arquivos):
